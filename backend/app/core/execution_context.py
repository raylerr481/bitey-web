...
class ExecutionContext:
    ...
    def as_dict(self) -> dict[str, Any]:
        return {
            ...
            "session": {"conversation_id": self.conversation_id, "channel": self.channel},
...
def server_execution_context(conversation_id: str) -> ExecutionContext:
    ...
    return build_execution_context(
        ...
        trusted_tenant_id=os.getenv("BITEY_TENANT_ID", "public"),
        trusted_user_id=os.getenv("BITEY_DEFAULT_USER_ID", "anonymous"),
        trusted_channel=os.getenv("BITEY_DEFAULT_CHANNEL", "api"),
        trusted_module_id=os.getenv("BITEY_DEFAULT_MODULE", "general"),
    )
