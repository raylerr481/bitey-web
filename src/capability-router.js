...
const TRADING_ACTION = /\b(analiza|analizar|señal|señales|compra|comprar|vende|vender|entrada|salida|operaci[oó]n|operar|cotizaci[oó]n|precio|gr[aá]fico|backtest|backtesting|estrategia|bot|robot|mt5|metatrader|tradingview|forecast|pron[oó]stico|invertir|inversi[oó]n)\b/i;
